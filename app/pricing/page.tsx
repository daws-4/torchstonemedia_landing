...
export default function PricingPage() {
  ...
  <div>
    <div>
      <h1 className = "text-5xl text-blue-950">Contacto</h1>
      <br />
    </div>
    ...
    <div className="bg-white p-6 max-w-md mx-auto text-center">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">TORCHTONE</h2>
    ...
    <div className="bg-white p-6 max-w-md mx-auto text-center">
        <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Venezuela</h2>
        <p className="text-gray-600 flex items-center">
    ...
    <div className="bg-white p-6 max-w-md mx-auto text-center">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Soporte</h2>
          <p className="text-gray-600 flex items-center">
          <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
          </svg>
    ...
    <div className="bg-white rounded-lg md:rounded-xl shadow-sm p-6 md:p-8 mb-8 md:mb-10 border border-gray-100 w-full">
        ...
        <h1 className = "text-2xl">Nuestro equipo está a su disposición para responder todas sus inquietudes de manera eficiente y en el menor tiempo posible.</h1>
        <br />
